			...
			<div class="form-holder">
				<div style="padding-top: 7px;padding-bottom: 23px;width:25%">
					<span class="lnr lnr-calendar-full"></span>
                                        Date of birth of the child : <input type="date" name="b_dob" id="myDate"  class="form-control" max="<?= date('Y-m-d'); ?>" min="2012-01-01" title="Date of birth" placeholder="Date of Birth" max="<?php echo date("Y-m-d") ?>">
				</div>
			</div>
...
?> -->
					...
					<input type="text" maxlength="3" name="b_age" id="age" class="form-control" title="age" placeholder="Age of the baby" required onchange="Validage();">
				</div>
			</div>
           ...
           $("#other").show(); 
			...
			<script>
				function Validname() {
					...
					if (!val.match(/^(\w*\s*[\#\-\,\/\.\(\)\&]*)+/)) {
						document.getElementById('msg4').innerHTML = "Enter a valid address";
