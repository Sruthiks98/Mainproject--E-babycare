...
{    
   ...
   $sql = "INSERT INTO `tbl_baby`(`r_id`,`b_dob`,`b_age`,`b_gender`,`b_name`,`b_relation`,`b_fname`,`b_mname`,`b_other`,`b_address`, `b_pob`, `b_hospital`,`b_weight`,`b_height`,`b_status`,`b_vacstatus`)
	VALUES('$a','$b_dob','$b_age','$b_gender','$b_name','$b_relation','$b_fname','$b_mname','$b_other','$b_address','$b_pob','$b_hospital','$b_weight','$b_height','1','0')";
