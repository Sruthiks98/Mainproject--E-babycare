...
<body>
  <div class="hero_area">
    ...
    <header class="header_section">
        <div class="contact_nav_container" style="background-color: #ea1d5d ! important;">
        <div class="container">
          <div class="contact_nav">
            <a href="">
              
              <span>
                Welcome To Pediatrician Home Page.
              </span>
            </a>
            <a href="">
    ...
    <a style="color: #fff" href= "addtoken.php">
         ...
         Token
            ...
            <a style="color: #fff" href= "userlogout.php">
              ...
              $qn=mysqli_query($con, "select *from tbl_pediatrician where ped_email='$um'");
              $r55=  mysqli_fetch_array($qn);
             ?>
                  Hai, <?php echo $r55['ped_name'];?>
              </span>
