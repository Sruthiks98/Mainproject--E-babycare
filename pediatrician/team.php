  ...
  <section class="team_section layout_padding">
    <div class="container-fluid">
      <div class="heading_container">
        ...
        <p>
          <a href= "listpediatrician.php"><h4>Pediatricians</h4></a>
		  <a href= "listnutritionist.php"><h4>Nutritionists</h4></a>
		  <a href= "listbabysitter.php"><h4>Babysitters</h4></a>
        </p>
      </div>
