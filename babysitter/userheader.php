...
<body>
  <div class="hero_area">
    ...
    <header class="header_section">
        <div class="contact_nav_container" style="background-color: #d98ca4  ! important;">
        <div class="container">
          <div class="contact_nav">
            <a href="">
              
              <span>
                Welcome To Babysitter Home Page.
              </span>
            </a>
            <a href="">
...
<div class="user_option"> 
    ...
    <a style="color: #fff" href= "addtoken.php">
         ...
         <a style="color: #fff" href= "userlogout.php">
              ...
              $qn=mysqli_query($con, "select *from tbl_babysitter where bbs_email='$um'");
              $r55=  mysqli_fetch_array($qn);
             ?>
                  Hai, <?php echo $r55['bbs_name'];?>
              </span>
