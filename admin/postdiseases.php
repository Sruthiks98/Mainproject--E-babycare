...
if(isset($_FILES['image']))
{
    ...
    $pic=$file_name;
              ...
              // $sql=  mysqli_query($con,"insert into tbl_disease
            ...
            <tr>
               ...
               <td><?php echo $row['Userid'] ?></td>
                <td colspan="3">
                    ...
                    {
                        ?>
                    <a href="appruve_diseases.php?disease_id=<?php echo $row['disease_id']; ?>" class='btn btn-success'>Approve</a>  
                    <?php 
                    }
                    ?>
                   <a href="postdiseasesedit.php?disease_id=<?php echo $row['disease_id']; ?>" class='btn btn-primary'>Edit</a>
                   <a href= "diseasedelete.php?disease_id=<?php echo $row['disease_id']; ?>" class='btn btn-danger'>Delete</a></td>
              </tr>
        <?php
        }
        ?>
