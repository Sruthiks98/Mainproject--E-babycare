...
<?php 
    ...
    include ("connect.php");
    $query = " select * from tbl_appointment where Utype='nutrition' ";
    $result = mysqli_query($con,$query);

?>

        
                    <div class=""><h3><center>NUTRITION APPOINTMENT</center></h3>
				...
				<td><?php echo $row['Adate'] ?></td>
                                       ...
                                       <!-- <td><a href= "n_appointment.php?id=<?php echo $row['Id']; ?>" class="btn btn-success">Send</a> 
                                       </td> -->
                                       <td><a href= "nu_appointment.php?id=<?php echo $row['Id']; ?>" class="btn btn-success">Send</a> 
                                       </td>
                                    </tr>   
                             <?php
