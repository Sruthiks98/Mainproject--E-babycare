...
if(isset($_FILES['image']))
{
    ...
    $pic=$file_name;
              ...
              // $sql=  mysqli_query($con,"insert into tbl_vac
                  // values('','$title','$des','$pic',1)");
                  if( mysqli_query($con,"insert into tbl_vaccination
                  values('','$title','$des',1)")){
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href= "vaccinationdelete.php?vac_id=<?php echo $row['vac_id']; ?>" class='btn btn-danger'>Delete</a>
                    <a href="addhospital.php?vac_id=<?php echo $row['vac_id']; ?>" class='btn btn-primary'>Add hospital</a>
                </td>
              </tr>
        <?php
        }
