...
$ppmail=$r11['ped_email'];
$b22=mysqli_query($con,"update `tbl_time` set l_status='0' where  pd='$ppmail' and Time='$atime'");
...
<!--                <div class="col-md-6">
              ...
              if(isset($_POST['s1']))
              {
                 ...
                 if($n2!='0')
                 {
                      ...
                      echo '<script>alert("Succesfully made appointment with Pediatrician...!");
              window.location.href="listpediatrician.php";        
</script>';
                 }
                 else
                 {
