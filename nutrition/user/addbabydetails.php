...
document.getElementById('msg3').innerHTML=" ";
    return true;
					...
					Date of birth : <input type="date" name="dob" id="myDate" class="form-control" min="1980-01-01" max="2010-12-30" title="Date of birth" placeholder="Date of Birth" max="<?php echo date("Y-m-d")?>" >
					</div>
					...
					&nbsp&nbsp&nbsp Gender : <input type="radio"  name="gender" value="male"> Male
