...
<div class="container bootstrap snippet">
  ...
  margin: 4px;"><centre>
               ...
               <table width=100%>
                   <tr><td><b>First Name:         </b><input type="text" name="nme" value="<?php echo $row['nut_name'];?>" /></td></tr>
	<tr><td><b>Sector :</b><input type="text" name="wrk" value="<?php echo $row['nut_workmode']; ?>" /></td></tr>
	<tr><td><b>Organization:</b><input type="text" name="org" value="<?php echo $row['nut_org'];?>" /></td></tr>
	<tr><td><b>Phone:</b><input type="text" name="phn" value="<?php echo $row['nut_phn'];?>" /></td></tr>
        <tr><td><input type="hidden" name="hid" value="<?php echo $row['nut_id'];?>" />
