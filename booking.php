      ...
      <div class="heading_container">
        <h2>
         Booking History
            ...
            <a class="btn btn-info" href= "viewbooking.php">Pediatricians Booking History</a><br/>
            <a class="btn btn-info" href= "view_n_booking.php">Nutritionists Booking History</a><br/>
            <a class="btn btn-info" href= "view_b_booking.php">Babysitters Booking History</a>
