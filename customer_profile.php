...
<div class="container bootstrap snippet">
  ...
  padding: 15px;
  margin: 4px;"><centre><table width=100%>
	...
	<tr><td><b>Phone:</b><?php echo " ".$fetch['r_phone']; ?></td></tr>
                      ...
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                              	<center><a class="btn btn-lg btn-success" href="customer_edit.php"><i class="glyphicon glyphicon-ok-sign"></i>Edit</a></center>
                                <!-- <a class="btn btn-lg btn-success" href="customer_change_password.php"><i class="glyphicon glyphicon-ok-sign"></i>Change Password</a> -->
