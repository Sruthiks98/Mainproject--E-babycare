...
if(isset($_FILES['image']))
{
    ...
    $pic=$file_name;
          ...
          ?>
    <center>    
                    <div class=""><h3>Post Baby Care Details</h3>
...
$query = " select * from tbl_babycare where Userid='$uname' ";
    ...
    <table align="center" width="50%" border="0" class="table table-bordered">
        ...
        ?>
            <tr>
                ...
                <td colspan="2">
                    <a href= "del_babycare.php?babycare_id=<?php echo $row['babycare_id']; ?>" class='btn btn-danger'>Delete</a></td>
              </tr>
        <?php
        }
        ?>
